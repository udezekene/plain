### [HTML5 Blank](http://plain.com) Changelog
...
* Added WAI-ARIA landmark roles to enrich semantics and improve accessibility. [Stacey Cordoni](https://github.com/staceycordoni) [#32](https://github.com/toddmotto/plain/pull/32)
...
* Separated WordPress script enqueue to load Conditionizr, Modernizr in head: 'function plain_header_scripts()'
* Hard-coded jQuery and CDN fallback into footer.php above custom theme scripts, more reliable fallback method
* Load custom theme scripts in footer: 'function plain_footer_scripts()'
...
* Custom Comments callback - wp_list_comments('type=comment&callback=plaincomments'); editable comments now in functions.php
...
* Custom callback for wp_nav_menu, now in functions.php with plain_nav(); in header.php
...
* Move toddmotto.com/plain/ to new plain.com domain
